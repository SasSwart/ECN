...
from PyQt5.QtWidgets import QApplication, QScrollArea, QHBoxLayout, QVBoxLayout, QMainWindow, QTabWidget, QAction, QTextEdit, QLineEdit, QWidget, QGridLayout, QComboBox, QLabel, QDateEdit, QPushButton
from PyQt5.QtCore import QDate
from connection import CONN
from defaults import QDATE_FORMAT, U_NAME, P_WORD, H_NAME, DB_NAME, replace_value
...
if __name__ == '__main__':
    ...
    main = Main()
    view = ViewTab()
    result = CONN.stmt()('SELECT')('code', 'first_name', 'last_name', 'company', 'vat', 'phone', 'cell', 'email', 'physical_address', 'postal_address')\
        ('FROM')('entity')()
    print(result[0].keys())
    #table.details.list_table(result, *result[0].keys())
    main.addTab('View', view)
    view.set_body(TableBrowser(), 1)
    main.showMaximized()
    sys.exit(app.exec())
