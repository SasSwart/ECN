...
void LoginDialog::setUserLabel(QString& label) {
	this->labelUsername->setText(label);
}

void LoginDialog::setPasswordLabel(QString& label) {
	this->labelPassword->setText(label);
}
